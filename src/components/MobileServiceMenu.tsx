  ...
  return (
    <div className="md:hidden mb-4 shadow-sm w-full rounded-lg overflow-hidden">
      ...
      >
        <Button 
          variant="outline"
          className="flex items-center justify-between w-full p-4 rounded-none border-x-0 shadow-sm touch-action-manipulation"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-0 w-full">
                {services.map((service) => (
                  <motion.button
                    ...
                    className={`px-4 py-4 text-left border-b hover:bg-muted transition-colors text-lg font-akaya touch-action-manipulation ${
