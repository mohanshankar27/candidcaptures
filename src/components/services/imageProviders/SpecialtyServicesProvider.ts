...
// Special image providers for various specialty services

export const getFoodPhotographyImages = (): string[] => {
  return [
...
export const getWeddingPhotographyImages = (): string[] => {
  return [
...
export const getConceptShootImages = (): string[] => {
  return [
