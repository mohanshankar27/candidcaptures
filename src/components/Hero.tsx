...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen relative bg-gradient-to-br from-indigo-50 via-white to-blue-50 overflow-hidden">
      {/* Abstract shapes with optimized rendering */}
      ...
      {/* Content - optimized animation classes */}
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center">
        <div className="text-center px-4 max-w-5xl backdrop-blur-sm py-12 rounded-2xl">
          ...
          <h1 className="flex flex-col text-5xl md:text-7xl lg:text-8xl font-serif italic font-bold mb-2 tracking-tight">
          ...
          <p className="text-xl md:text-2xl text-gray-600 font-serif italic mt-4 max-w-3xl mx-auto">
          ...
          <div className="mt-8 mb-10 max-w-3xl mx-auto relative group">
            ...
            <p className="relative text-xl md:text-3xl font-semibold text-white px-8 py-4 rounded-xl bg-primary/90 backdrop-blur-sm border border-blue-100/40 shadow-lg">
              "Every Click Tells Your Unique Story — Moments Capture, Memories Forever"
            </p>
          </div>
          
          <div className="h-1 w-24 bg-gradient-to-r from-primary to-blue-500 mx-auto mt-2"></div>
