...
const WhatsAppButton = () => {
  ...
  return (
    <div className="fixed right-4 bottom-24 transform z-40">
      ...
      >
        <Button
          className="group flex flex-col items-center gap-2 px-3 py-6 bg-white shadow-lg hover:bg-green-50 text-green-600 rounded-full transition-all duration-300 hover:scale-105"
        >
