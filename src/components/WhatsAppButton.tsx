...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Pulse animation */}
        <span className="absolute inset-0 rounded-full animate-ping bg-green-500 opacity-25"></span>
        
        {/* WhatsApp Icon */}
        <div className="relative flex items-center justify-center w-16 h-16 bg-green-500 text-white rounded-full shadow-lg">
          <svg 
            viewBox="0 0 24 24" 
            className="w-8 h-8"
