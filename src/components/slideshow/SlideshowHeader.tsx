...
const SlideshowHeader = ({ onToggleFullscreen }: SlideshowHeaderProps) => {
  ...
  return (
    <div className="text-center mb-12 md:mb-16 relative z-10">
      ...
      <div className="mb-6 md:mb-8 -mx-4 w-screen relative left-1/2 transform -translate-x-1/2">
      ...
      <div className="relative">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-72 md:w-96 h-16 md:h-20 bg-orange-300/10 blur-3xl rounded-full"></div>
        ...
        <div className="flex items-center justify-center">
          <motion.h2 
            ...
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-arjulian italic text-primary mb-4 tracking-wide relative"
          >
            ...
            <motion.span 
              ...
              initial={{ width: 0 }}
              animate={{ width: "100%" }}
              transition={{ duration: isMobile ? 0.8 : 1.2, ease: "easeOut", delay: 0.3 }}
            ></motion.span>
          </motion.h2>
        ...
        <motion.div 
          className="w-16 md:w-24 h-[2px] bg-gradient-to-r from-orange-300 via-amber-500 to-orange-300 mx-auto rounded-full mb-4 md:mb-6 overflow-hidden relative"
          initial={{ width: 0 }}
          animate={{ width: isMobile ? "4rem" : "6rem" }}
          transition={{ duration: isMobile ? 0.8 : 1.2, ease: "easeOut", delay: 0.4 }}
        ></motion.div>
      </div>
    </div>
  );
